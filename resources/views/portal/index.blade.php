			...
			<div class="row">
				<div class="col-xl-8 col-lg-6 col-md-7 col-sm-8">
					<div class="card-bx stacked">
						<img src="{{ asset('retail/images/card/card.png') }}" alt="" class="mw-100">
						<div class="card-info text-white">
							...
							<div class="d-flex align-items-center justify-content-between mb-sm-5 mb-3">
								<img src="{{ asset('retail/images/dual-dot.png') }}" alt="" class="dot-img">
				...
				<div class="col-xl-12">
					<div class="card">
						...
						<div class="card-body">
							<div id="chartBar"></div>
							<div class="d-flex">
								<div class="form-check custom-switch toggle-switch text-right me-4 mb-2">
									<input type="checkbox" class="form-check-input" id="customSwitch11">
									<label class="form-check-label fs-14 text-black pr-2" for="customSwitch11">Number</label>
								</div>
								<div class="form-check custom-switch toggle-switch text-right me-4 mb-2">
									<input type="checkbox" class="form-check-input" id="customSwitch12">
									<label class="form-check-label fs-14 text-black pr-2" for="customSwitch12">Analytics</label>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="owl-carousel testimonial-one mb-5">
								<div class="item">
									<div class="image-bx mb-3">
										<img src="{{ asset('retail/images/avatar/1.jpg') }}" alt="">
								...
								<div class="item">
									<div class="image-bx mb-3">
										<img src="{{ asset('retail/images/avatar/2.jpg') }}" alt="">
										<i class="las la-check-circle"></i>
									</div>
								...
								<div class="item">
									<div class="image-bx mb-3">
										<img src="{{ asset('retail/images/avatar/3.jpg') }}" alt="">
										<i class="las la-check-circle"></i>
									</div>
								...
								<div class="item">
									<div class="image-bx mb-3">
										<img src="{{ asset('retail/images/avatar/4.jpg') }}" alt="">
										<i class="las la-check-circle"></i>
									</div>
								...
								<div class="item">
									<div class="image-bx mb-3">
										<img src="{{ asset('retail/images/avatar/5.jpg') }}" alt="">
										<i class="las la-check-circle"></i>
									</div>
									...
									<div class="row">
										<div class="d-flex col-xl-12 col-xxl-6  col-md-12 col-sm-6 mb-4">
											...
											<div>
												...
												<span class="fs-18 font-w500"><span class="text-black me-2">$1,415</span>/$2,000</span>
											</div>
										</div>
										<div class="d-flex col-xl-12 col-xxl-6 col-md-12 col-sm-6 mb-4">
											<svg class="me-3" width="14" height="54" viewBox="0 0 14 54" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<div>
												...
												<span class="fs-18 font-w500"><span class="text-black me-2">$1,567</span>/$5,000</span>
											</div>
										</div>
										<div class="d-flex col-xl-12 col-xxl-6 col-md-12 col-sm-6 mb-4">
											<svg class="me-3" width="14" height="54" viewBox="0 0 14 54" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<div>
												...
												<span class="fs-18 font-w500"><span class="text-black me-2">$487</span>/$10,000</span>
											</div>
										</div>
										<div class="d-flex col-xl-12 col-xxl-6 col-md-12 col-sm-6 mb-4">
											<svg class="me-3" width="14" height="54" viewBox="0 0 14 54" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<div>
												...
												<span class="fs-18 font-w500"><span class="text-black me-2">$3,890</span>/$4,000</span>
											</div>
										</div>
									</div>
								</div>
